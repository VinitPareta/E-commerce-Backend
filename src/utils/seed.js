...
const products = [
  ...
  },
  {
    ...
    sizes: ['XS', 'S', 'M', 'L'],
    colors: ['White', 'Pink'],
    images: [img('1490481651871-ab68de25d43d'), img('1539109136881-3be0616acf4b')],
    stock: 18,
    isFeatured: true,
    rating: 4.8,
    numReviews: 31,
  ...
  },
  {
    ...
    images: [img('1602810318383-e386cc2a3ccf'), img('1620012253295-c15cc3e65df4')],
    stock: 30,
    isTrending: true,
    rating: 4.2,
    numReviews: 15,
  },
  {
    ...
    images: [img('1584917865442-de89df76afd3'), img('1591561954557-26941169b49e')],
    stock: 20,
    isFeatured: true,
    rating: 4.7,
    numReviews: 22,
  },
  {
    ...
    images: [img('1523275335684-37898b6baf30'), img('1524592094714-0f0654e20314')],
    stock: 15,
    isTrending: true,
    rating: 4.6,
    numReviews: 28,
...
const seedDatabase = async () => {
  ...
  console.log(`Seeded ${createdUsers.length} users, ${createdProducts.length} products`);
